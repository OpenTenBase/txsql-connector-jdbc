...
public class Jdk14Logger implements Log {
    ...
    private static final int findCallerStackDepth(StackTraceElement[] stackTrace) {
        ...
        for (int i = 0; i < numFrames; i++) {
            ...
            if (!(callerClassName.startsWith("com.tencentcloud.tdsql.mysql.cj") || callerClassName.startsWith("com.tencentcloud.tdsql.mysql.cj.core")
                    || callerClassName.startsWith("com.tencentcloud.tdsql.mysql.cj.jdbc"))) {
                return i;
            }
        }
