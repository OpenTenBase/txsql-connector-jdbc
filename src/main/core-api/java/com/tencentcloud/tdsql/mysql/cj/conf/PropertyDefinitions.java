    ...
    static {
        ...
        PropertyDefinition<?>[] pdefs = new PropertyDefinition<?>[] {
                ...
                new IntegerPropertyDefinition(PropertyKey.tdsqlDirectProxyConnectMaxIdleTime,
                        ...
                        CATEGORY_HA,
                        Integer.MIN_VALUE),
                new IntegerPropertyDefinition(PropertyKey.tdsqlDirectInitDatasourceTimeout,
                        DEFAULT_TDSQL_DIRECT_INIT_CONN_TIMEOUT_MILLS,
                        RUNTIME_NOT_MODIFIABLE,
                        Messages.getString("ConnectionProperties.tdsqlDirectInitDatasourceTimeout"),
                        "1.5.1",
                        CATEGORY_HA,
                        Integer.MIN_VALUE),
