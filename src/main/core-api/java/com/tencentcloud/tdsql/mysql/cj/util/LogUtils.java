...
public class LogUtils {
    ...
    public static String findCallingClassAndMethod(Throwable t) {
        ...
        int endInternalMethods = Math.max(Math.max(stackTraceAsString.lastIndexOf("com.tencentcloud.tdsql.mysql.cj"), stackTraceAsString.lastIndexOf("com.tencentcloud.tdsql.mysql.cj.core")),
                stackTraceAsString.lastIndexOf("com.tencentcloud.tdsql.mysql.cj.jdbc"));
