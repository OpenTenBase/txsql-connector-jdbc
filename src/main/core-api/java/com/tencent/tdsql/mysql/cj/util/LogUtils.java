...
public class LogUtils {
    ...
    public static String findCallingClassAndMethod(Throwable t) {
        ...
        int endInternalMethods = Math.max(Math.max(stackTraceAsString.lastIndexOf("com.tencent.tdsql.mysql.cj"), stackTraceAsString.lastIndexOf("com.tencent.tdsql.mysql.cj.core")),
                stackTraceAsString.lastIndexOf("com.tencent.tdsql.mysql.cj.jdbc"));
