...
package com.tencent.tdsql.mysql.cj.conf;
...
import com.tencent.tdsql.mysql.cj.PerConnectionLRUFactory;
import com.tencent.tdsql.mysql.cj.log.Log;
import com.tencent.tdsql.mysql.cj.log.StandardLogger;
import com.tencent.tdsql.mysql.cj.util.PerVmServerConfigCacheFactory;
...
public class PropertyDefinitions {
     ...
     */
    public static final String SYSP_disableAbandonedConnectionCleanup = "com.tencent.tdsql.mysql.cj.disableAbandonedConnectionCleanup";

    /*
     * Testsuite system properties.
     */
    public static final String SYSP_testsuite_url /*                          */ = "com.tencent.tdsql.mysql.cj.testsuite.url";
    public final static String SYSP_testsuite_url_admin /*                    */ = "com.tencent.tdsql.mysql.cj.testsuite.url.admin";
    public static final String SYSP_testsuite_url_cluster /*                  */ = "com.tencent.tdsql.mysql.cj.testsuite.url.cluster";
    /** Connection string to server compiled with OpenSSL */
    public static final String SYSP_testsuite_url_openssl /*                  */ = "com.tencent.tdsql.mysql.cj.testsuite.url.openssl";

    public static final String SYSP_testsuite_url_mysqlx /*                   */ = "com.tencent.tdsql.mysql.cj.testsuite.mysqlx.url";
    public static final String SYSP_testsuite_url_mysqlx_openssl /*           */ = "com.tencent.tdsql.mysql.cj.testsuite.mysqlx.url.openssl";

    public static final String SYSP_testsuite_cantGrant /*                    */ = "com.tencent.tdsql.mysql.cj.testsuite.cantGrant";
    public static final String SYSP_testsuite_disable_multihost_tests /*      */ = "com.tencent.tdsql.mysql.cj.testsuite.disable.multihost.tests"; // TODO should be more specific for different types of multi-host configs

    public static final String SYSP_testsuite_unavailable_host /*             */ = "com.tencent.tdsql.mysql.cj.testsuite.unavailable.host";

    /** Option to indicate that the server was installed without the test package */
    public static final String SYSP_testsuite_no_server_testsuite /*          */ = "com.tencent.tdsql.mysql.cj.testsuite.no.server.testsuite";

    /** For testsuite.regression.DataSourceRegressionTest */
    public static final String SYSP_testsuite_ds_host /*                      */ = "com.tencent.tdsql.mysql.cj.testsuite.ds.host";
    /** For testsuite.regression.DataSourceRegressionTest */
    public static final String SYSP_testsuite_ds_port /*                      */ = "com.tencent.tdsql.mysql.cj.testsuite.ds.port";
    /** For testsuite.regression.DataSourceRegressionTest */
    public static final String SYSP_testsuite_ds_db /*                        */ = "com.tencent.tdsql.mysql.cj.testsuite.ds.db";
    /** For testsuite.regression.DataSourceRegressionTest */
    public static final String SYSP_testsuite_ds_user /*                      */ = "com.tencent.tdsql.mysql.cj.testsuite.ds.user";
    /** For testsuite.regression.DataSourceRegressionTest */
    public static final String SYSP_testsuite_ds_password /*                  */ = "com.tencent.tdsql.mysql.cj.testsuite.ds.password";

    /** For testsuite.perf.LoadStorePerfTest */
    public static final String SYSP_testsuite_loadstoreperf_tabletype /*      */ = "com.tencent.tdsql.mysql.cj.testsuite.loadstoreperf.tabletype"; // TODO document allowed types
    /** For testsuite.perf.LoadStorePerfTest */
    public static final String SYSP_testsuite_loadstoreperf_useBigResults /*  */ = "com.tencent.tdsql.mysql.cj.testsuite.loadstoreperf.useBigResults";

    /** The system property that must exist to run the shutdown test in testsuite.simple.MiniAdminTest */
    public static final String SYSP_testsuite_miniAdminTest_runShutdown /*    */ = "com.tencent.tdsql.mysql.cj.testsuite.miniAdminTest.runShutdown";

    /** Suppress debug output when running testsuite */
    public static final String SYSP_testsuite_noDebugOutput /*                */ = "com.tencent.tdsql.mysql.cj.testsuite.noDebugOutput";
    /** Don't remove database object created by tests */
    public static final String SYSP_testsuite_retainArtifacts /*              */ = "com.tencent.tdsql.mysql.cj.testsuite.retainArtifacts";
    public static final String SYSP_testsuite_runLongTests /*                 */ = "com.tencent.tdsql.mysql.cj.testsuite.runLongTests";
    public static final String SYSP_testsuite_serverController_basedir /*     */ = "com.tencent.tdsql.mysql.cj.testsuite.serverController.basedir";

    /*
     * Build system properties.
     */
    public static final String SYSP_com_mysql_cj_build_verbose /*             */ = "com.tencent.tdsql.mysql.cj.build.verbose";
    ...
    static {
        ...
        PropertyDefinition<?>[] pdefs = new PropertyDefinition<?>[] {
                ...
                new StringPropertyDefinition(PropertyKey.clientInfoProvider, "com.tencent.tdsql.mysql.cj.jdbc.CommentClientInfoProvider", RUNTIME_MODIFIABLE,
                ...
                new StringPropertyDefinition(PropertyKey.socketFactory, "com.tencent.tdsql.mysql.cj.protocol.StandardSocketFactory", RUNTIME_MODIFIABLE,
                ...
                new StringPropertyDefinition(PropertyKey.loadBalanceExceptionChecker, "com.tencent.tdsql.mysql.cj.jdbc.ha.StandardLoadBalanceExceptionChecker",
                ...
                new StringPropertyDefinition(PropertyKey.profilerEventHandler, "com.tencent.tdsql.mysql.cj.log.LoggingProfilerEventHandler", RUNTIME_MODIFIABLE,
