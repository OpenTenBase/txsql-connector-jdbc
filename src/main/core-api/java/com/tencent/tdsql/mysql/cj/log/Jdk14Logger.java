...
package com.tencent.tdsql.mysql.cj.log;
...
public class Jdk14Logger implements Log {
    ...
    private static final int findCallerStackDepth(StackTraceElement[] stackTrace) {
        ...
        for (int i = 0; i < numFrames; i++) {
            ...
            if (!(callerClassName.startsWith("com.tencent.tdsql.mysql.cj") || callerClassName.startsWith("com.tencent.tdsql.mysql.cj.core")
                    || callerClassName.startsWith("com.tencent.tdsql.mysql.cj.jdbc"))) {
                return i;
            }
        }
