...
package com.tencent.tdsql.mysql.cj.util;
...
public class Util {
    ...
    /**
     * Recursively checks for interfaces on the given class to determine if it implements a java.sql, javax.sql or com.tencent.tdsql.mysql.cj.jdbc interface.
     * 
     * @param clazz
    ...
    public static boolean isJdbcPackage(String packageName) {
        return packageName != null
                && (packageName.startsWith("java.sql") || packageName.startsWith("javax.sql") || packageName.startsWith("com.tencent.tdsql.mysql.cj.jdbc"));
    }
