...
import com.tencent.tdsql.mysql.cj.xdevapi.ExprUnparser;
...
public class DataStoreMetadataImpl implements DataStoreMetadata {
    ...
    public boolean schemaExists(String schemaName) {
        ...
        Function<com.tencent.tdsql.mysql.cj.result.Row, Long> rowToLong = r -> r.getValue(0, new LongValueFactory(this.session.getPropertySet()));
