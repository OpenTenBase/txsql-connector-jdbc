...
package com.tencentcloud.tdsql.mysql.cj.protocol.result;
...
public abstract class AbstractResultsetRow implements ResultsetRow {
    ...
    /**
     * Get a value from a byte array. The byte array is interpreted by the {@link com.tencentcloud.tdsql.mysql.cj.protocol.ValueDecoder} which uses the value factory create the
     * return value.
     * 
     * @param columnIndex
