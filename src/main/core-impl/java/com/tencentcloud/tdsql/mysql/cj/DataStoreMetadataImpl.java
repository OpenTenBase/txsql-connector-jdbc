...
import com.tencentcloud.tdsql.mysql.cj.xdevapi.ExprUnparser;
...
public class DataStoreMetadataImpl implements DataStoreMetadata {
    ...
    public boolean schemaExists(String schemaName) {
        ...
        Function<com.tencentcloud.tdsql.mysql.cj.result.Row, Long> rowToLong = r -> r.getValue(0, new LongValueFactory(this.session.getPropertySet()));
