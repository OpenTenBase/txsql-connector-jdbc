...
import com.tencent.tdsql.mysql.cj.protocol.Warning;
...
public class Notice implements ProtocolEntity {
    ...
    public static class XWarning extends Notice implements Warning {
        ...
        public XWarning(Frame frm) {
            super(frm);
            com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxNotice.Warning warn = parseNotice(frm.getPayload(), com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxNotice.Warning.class);
