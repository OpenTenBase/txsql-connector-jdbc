...
public class StatementExecuteOk implements ProtocolEntity, Result {
    ...
    @Override
    public Iterator<com.tencent.tdsql.mysql.cj.xdevapi.Warning> getWarnings() {
        return this.warnings.stream().map(w -> (com.tencent.tdsql.mysql.cj.xdevapi.Warning) new WarningImpl(w)).collect(Collectors.toList()).iterator();
    }
