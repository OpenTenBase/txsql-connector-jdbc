...
import com.tencent.tdsql.mysql.cj.exceptions.ConnectionIsClosedException;
...
import com.tencent.tdsql.mysql.cj.exceptions.SSLParamsException;
...
import com.tencent.tdsql.mysql.cj.protocol.MessageListener;
...
import com.tencent.tdsql.mysql.cj.protocol.ResultStreamer;
import com.tencent.tdsql.mysql.cj.protocol.Resultset;
import com.tencent.tdsql.mysql.cj.protocol.ServerCapabilities;
import com.tencent.tdsql.mysql.cj.protocol.ServerSession;
import com.tencent.tdsql.mysql.cj.protocol.SocketConnection;
import com.tencent.tdsql.mysql.cj.protocol.a.NativeSocketConnection;
import com.tencent.tdsql.mysql.cj.protocol.x.Notice.XSessionStateChanged;
import com.tencent.tdsql.mysql.cj.result.DefaultColumnDefinition;
import com.tencent.tdsql.mysql.cj.result.Field;
import com.tencent.tdsql.mysql.cj.result.LongValueFactory;
...
import com.tencent.tdsql.mysql.cj.xdevapi.PreparableStatement.PreparableStatementFinalizer;
...
public class XProtocol extends AbstractProtocol<XMessage> implements Protocol<XMessage> {
    ...
    public void init(Session sess, SocketConnection socketConn, PropertySet propSet, TransactionEventHandler trManager) {
        ...
        this.messageToProtocolEntityFactory.put(com.tencent.tdsql.mysql.cj.x.protobuf.Mysqlx.Ok.class, new OkFactory());
    }
