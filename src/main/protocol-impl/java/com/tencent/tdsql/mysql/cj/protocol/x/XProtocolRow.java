 ...
 */
public class XProtocolRow implements com.tencent.tdsql.mysql.cj.result.Row {
    ...
    @Override
    public com.tencent.tdsql.mysql.cj.result.Row setMetadata(ColumnDefinition columnDefinition) {
    ...
    public <T> T getValue(int columnIndex, ValueFactory<T> vf) {
        ...
        // for debugging
        //System.err.println("getValue bytes = " + com.tencent.tdsql.mysql.cj.core.util.StringUtils.dumpAsHex(byteString.toByteArray(), byteString.toByteArray().length));
        //try {
