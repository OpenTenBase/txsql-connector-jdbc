...
package com.tencent.tdsql.mysql.cj.protocol.a;
...
import com.tencent.tdsql.mysql.cj.QueryResult;
...
import com.tencent.tdsql.mysql.cj.TransactionEventHandler;
import com.tencent.tdsql.mysql.cj.conf.PropertyKey;
import com.tencent.tdsql.mysql.cj.conf.PropertySet;
import com.tencent.tdsql.mysql.cj.conf.RuntimeProperty;
import com.tencent.tdsql.mysql.cj.conf.RuntimeProperty.RuntimePropertyListener;
import com.tencent.tdsql.mysql.cj.exceptions.CJCommunicationsException;
import com.tencent.tdsql.mysql.cj.exceptions.CJConnectionFeatureNotAvailableException;
import com.tencent.tdsql.mysql.cj.exceptions.CJException;
import com.tencent.tdsql.mysql.cj.exceptions.CJOperationNotSupportedException;
...
import com.tencent.tdsql.mysql.cj.exceptions.DataTruncationException;
...
import com.tencent.tdsql.mysql.cj.log.BaseMetricsHolder;
import com.tencent.tdsql.mysql.cj.log.Log;
import com.tencent.tdsql.mysql.cj.log.ProfilerEvent;
import com.tencent.tdsql.mysql.cj.log.ProfilerEventHandler;
import com.tencent.tdsql.mysql.cj.protocol.AbstractProtocol;
import com.tencent.tdsql.mysql.cj.protocol.AuthenticationProvider;
import com.tencent.tdsql.mysql.cj.protocol.ColumnDefinition;
import com.tencent.tdsql.mysql.cj.protocol.ExportControlled;
import com.tencent.tdsql.mysql.cj.protocol.FullReadInputStream;
...
import com.tencent.tdsql.mysql.cj.protocol.Protocol;
import com.tencent.tdsql.mysql.cj.protocol.ProtocolEntity;
import com.tencent.tdsql.mysql.cj.protocol.ProtocolEntityFactory;
import com.tencent.tdsql.mysql.cj.protocol.ProtocolEntityReader;
import com.tencent.tdsql.mysql.cj.protocol.ResultBuilder;
import com.tencent.tdsql.mysql.cj.protocol.Resultset;
import com.tencent.tdsql.mysql.cj.protocol.Resultset.Concurrency;
import com.tencent.tdsql.mysql.cj.protocol.Resultset.Type;
import com.tencent.tdsql.mysql.cj.protocol.ResultsetRow;
import com.tencent.tdsql.mysql.cj.protocol.ResultsetRows;
import com.tencent.tdsql.mysql.cj.protocol.ServerSession;
import com.tencent.tdsql.mysql.cj.protocol.SocketConnection;
import com.tencent.tdsql.mysql.cj.protocol.a.result.OkPacket;
...
import com.tencent.tdsql.mysql.cj.util.TestUtils;
...
public class NativeProtocol extends AbstractProtocol<NativePacketPayload> implements Protocol<NativePacketPayload>, RuntimePropertyListener {
    ...
    public void negotiateSSLConnection() {
        ...
        packet.writeInteger(NativeConstants.IntegerDataType.INT4, NativeConstants.MAX_PACKET_SIZE);
        packet.writeInteger(NativeConstants.IntegerDataType.INT1, AuthenticationProvider.getCharsetForHandshake(this.authProvider.getEncodingForHandshake(),
                this.serverSession.getCapabilities().getServerVersion()));
        packet.writeBytes(NativeConstants.StringLengthDataType.STRING_FIXED, new byte[23]);  // Set of bytes reserved for future use.
    ...
    public void checkErrorMessage(NativePacketPayload resultPacket) {
        ...
        if (statusCode == (byte) 0xff) {
            ...
            serverErrorMessage = resultPacket.readString(NativeConstants.StringSelfDataType.STRING_TERM, this.serverSession.getErrorMessageEncoding());
    ...
    public final <T extends Resultset> T sendQueryString(Query callingQuery, String query, String characterEncoding, int maxRows, boolean streamResults,
        ...
        sendPacket.writeInteger(NativeConstants.IntegerDataType.INT1, NativeConstants.COM_QUERY);
    ...
    public final <T> T readServerStatusForResultSets(NativePacketPayload rowPacket, boolean saveOldStatus) {
        ...
        if (rowPacket.isEOFPacket()) {
            // read EOF packet
            rowPacket.readInteger(NativeConstants.IntegerDataType.INT1); // skips the 'last packet' flag (packet signature)
