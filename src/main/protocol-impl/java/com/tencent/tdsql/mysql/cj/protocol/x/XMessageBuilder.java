...
package com.tencent.tdsql.mysql.cj.protocol.x;
...
import com.tencent.tdsql.mysql.cj.MessageBuilder;
import com.tencent.tdsql.mysql.cj.Messages;
import com.tencent.tdsql.mysql.cj.protocol.Security;
import com.tencent.tdsql.mysql.cj.util.StringUtils;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxConnection.Capabilities;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxConnection.CapabilitiesGet;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxConnection.CapabilitiesSet;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxConnection.Capability;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.Collection;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.Column;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.DataModel;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.Delete;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.Find;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.Find.RowLock;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.Find.RowLockOptions;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.Insert;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.Insert.TypedRow;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.Limit;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.LimitExpr;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.Order;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.Projection;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.Update;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.UpdateOperation;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxCrud.UpdateOperation.UpdateType;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Any;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Object.Builder;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Object.ObjectField;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Scalar;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxExpect;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxExpr.ColumnIdentifier;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxExpr.Expr;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxPrepare.Deallocate;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxPrepare.Execute;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxPrepare.Prepare;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxPrepare.Prepare.OneOfMessage;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxSession.AuthenticateContinue;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxSession.AuthenticateStart;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxSession.Close;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxSession.Reset;
import com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxSql.StmtExecute;
import com.tencent.tdsql.mysql.cj.xdevapi.CreateIndexParams;
import com.tencent.tdsql.mysql.cj.xdevapi.CreateIndexParams.IndexField;
import com.tencent.tdsql.mysql.cj.xdevapi.ExprUtil;
import com.tencent.tdsql.mysql.cj.xdevapi.FilterParams;
import com.tencent.tdsql.mysql.cj.xdevapi.InsertParams;
...
import com.tencent.tdsql.mysql.cj.xdevapi.UpdateParams;
import com.tencent.tdsql.mysql.cj.xdevapi.UpdateSpec;
...
public class XMessageBuilder implements MessageBuilder<XMessage> {
    ...
    public XMessage buildCreateCollection(String schemaName, String collectionName, CreateCollectionOptions options) {
        ...
        Builder argsBuilder = com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Object.newBuilder()
        ...
        Builder optBuilder = com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Object.newBuilder();
        ...
        if (options.getValidation() != null) {
            hasOptions = true;
            Builder validationBuilder = com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Object.newBuilder();
    ...
    public XMessage buildCreateCollection(String schemaName, String collectionName) {
        ...
        return new XMessage(buildXpluginCommand(XpluginStatementCommand.XPLUGIN_STMT_CREATE_COLLECTION,
                Any.newBuilder().setType(Any.Type.OBJECT)
                        .setObj(com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Object.newBuilder()
                                .addFld(ObjectField.newBuilder().setKey("name").setValue(ExprUtil.buildAny(collectionName)))
                                .addFld(ObjectField.newBuilder().setKey("schema").setValue(ExprUtil.buildAny(schemaName))))
                        .build()));
    }
    ...
    public XMessage buildListObjects(String schemaName, String pattern) {
        ...
        Builder obj = com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Object.newBuilder()
                .addFld(ObjectField.newBuilder().setKey("schema").setValue(ExprUtil.buildAny(schemaName)));
    ...
    public XMessage buildEnableNotices(String... notices) {
        com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Array.Builder abuilder = com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Array.newBuilder();
    ...
    public XMessage buildCreateCollectionIndex(String schemaName, String collectionName, CreateIndexParams params) {
        com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Object.Builder builder = com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Object.newBuilder();
        ...
        for (IndexField indexField : params.getFields()) {
            com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Object.Builder fBuilder = com.tencent.tdsql.mysql.cj.x.protobuf.MysqlxDatatypes.Object.newBuilder()
