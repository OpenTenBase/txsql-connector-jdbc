...
public class Notice implements ProtocolEntity {
    ...
    public static class XWarning extends Notice implements Warning {
        ...
        public XWarning(Frame frm) {
            super(frm);
            com.tencentcloud.tdsql.mysql.cj.x.protobuf.MysqlxNotice.Warning warn = parseNotice(frm.getPayload(), com.tencentcloud.tdsql.mysql.cj.x.protobuf.MysqlxNotice.Warning.class);
