...
import com.tencentcloud.tdsql.mysql.cj.exceptions.ConnectionIsClosedException;
...
import com.tencentcloud.tdsql.mysql.cj.protocol.MessageListener;
...
import com.tencentcloud.tdsql.mysql.cj.protocol.ResultStreamer;
...
import com.tencentcloud.tdsql.mysql.cj.xdevapi.PreparableStatement.PreparableStatementFinalizer;
...
public class XProtocol extends AbstractProtocol<XMessage> implements Protocol<XMessage> {
    ...
    public void init(Session sess, SocketConnection socketConn, PropertySet propSet, TransactionEventHandler trManager) {
        ...
        this.messageToProtocolEntityFactory.put(com.tencentcloud.tdsql.mysql.cj.x.protobuf.Mysqlx.Ok.class, new OkFactory());
    }
