...
import static com.tencentcloud.tdsql.mysql.cj.protocol.x.XMessageHeader.HEADER_LENGTH;
...
public class CompressionSplittedInputStream extends FilterInputStream {
     ...
     * 
     * @return
     *         <code>true</code> if the type of current frame is {@link com.tencentcloud.tdsql.mysql.cj.x.protobuf.Mysqlx.ServerMessages.Type#COMPRESSION}, <code>false</code>
     *         otherwise.
     */
