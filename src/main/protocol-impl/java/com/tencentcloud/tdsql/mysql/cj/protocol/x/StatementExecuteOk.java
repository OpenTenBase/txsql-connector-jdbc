...
import com.tencentcloud.tdsql.mysql.cj.protocol.Warning;
...
public class StatementExecuteOk implements ProtocolEntity, Result {
    ...
    @Override
    public Iterator<com.tencentcloud.tdsql.mysql.cj.xdevapi.Warning> getWarnings() {
        return this.warnings.stream().map(w -> (com.tencentcloud.tdsql.mysql.cj.xdevapi.Warning) new WarningImpl(w)).collect(Collectors.toList()).iterator();
    }
