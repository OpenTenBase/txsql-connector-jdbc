 ...
 */
public class XProtocolRow implements com.tencentcloud.tdsql.mysql.cj.result.Row {
    ...
    @Override
    public com.tencentcloud.tdsql.mysql.cj.result.Row setMetadata(ColumnDefinition columnDefinition) {
    ...
    public <T> T getValue(int columnIndex, ValueFactory<T> vf) {
        ...
        // for debugging
        //System.err.println("getValue bytes = " + com.tencentcloud.tdsql.mysql.cj.core.util.StringUtils.dumpAsHex(byteString.toByteArray(), byteString.toByteArray().length));
        //try {
