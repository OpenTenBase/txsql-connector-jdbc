...
public final class TdsqlConst {
    ...
    public static final Integer TDSQL_DIRECT_TOPO_REFRESH_CONN_TIMEOUT_MILLIS = 5000;
    public static final Integer TDSQL_DIRECT_CLOSE_CONN_TIMEOUT_MILLIS = 5000;
    public static final Integer TDSQL_DIRECT_TOPO_REFRESH_STMT_TIMEOUT_SECONDS = 5;
