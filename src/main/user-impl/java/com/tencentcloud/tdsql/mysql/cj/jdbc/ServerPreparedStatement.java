...
import com.tencentcloud.tdsql.mysql.cj.ServerPreparedQueryBindValue;
import com.tencentcloud.tdsql.mysql.cj.ServerPreparedQueryBindings;
...
public class ServerPreparedStatement extends ClientPreparedStatement {
    ...
    @Override
    protected <M extends Message> com.tencentcloud.tdsql.mysql.cj.jdbc.result.ResultSetInternalMethods executeInternal(int maxRowsToRetrieve, M sendPacket,
