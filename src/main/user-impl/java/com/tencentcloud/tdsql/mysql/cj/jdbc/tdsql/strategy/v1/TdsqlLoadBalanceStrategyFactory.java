...
public class TdsqlLoadBalanceStrategyFactory {
    ...
    public TdsqlLoadBalanceStrategyFactory() {
    }

    public static TdsqlLoadBalanceStrategyFactory getInstance() {
        return TdsqlLoadBalanceStrategyFactory.SingletonInstance.INSTANCE;
    }

    private static class SingletonInstance {

        private static final TdsqlLoadBalanceStrategyFactory INSTANCE = new TdsqlLoadBalanceStrategyFactory();
    }
}