...
public class MysqlPooledConnection implements PooledConnection {
    ...
    protected static MysqlPooledConnection getInstance(com.tencentcloud.tdsql.mysql.cj.jdbc.JdbcConnection connection) throws SQLException {
    ...
    private com.tencentcloud.tdsql.mysql.cj.jdbc.JdbcConnection physicalConn;
     ...
     */
    public MysqlPooledConnection(com.tencentcloud.tdsql.mysql.cj.jdbc.JdbcConnection connection) {
