...
public class ConnectionWrapper extends WrapperBase implements JdbcConnection {
    ...
    @Override
    public boolean isSameResource(com.tencentcloud.tdsql.mysql.cj.jdbc.JdbcConnection c) {
    ...
    @Override
    public void registerStatement(com.tencentcloud.tdsql.mysql.cj.jdbc.JdbcStatement stmt) {
    ...
    @Override
    public void unregisterStatement(com.tencentcloud.tdsql.mysql.cj.jdbc.JdbcStatement stmt) {
