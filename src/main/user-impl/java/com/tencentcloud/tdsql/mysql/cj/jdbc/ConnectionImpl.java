...
public class ConnectionImpl implements JdbcConnection, SessionEventListener, Serializable {
    ...
    private java.sql.DatabaseMetaData getMetaData(boolean checkClosed, boolean checkForInfoSchema) throws SQLException {
        ...
        com.tencentcloud.tdsql.mysql.cj.jdbc.DatabaseMetaData dbmeta = com.tencentcloud.tdsql.mysql.cj.jdbc.DatabaseMetaData.getInstance(getMultiHostSafeProxy(), this.database, checkForInfoSchema,
    ...
    public Clob createClob() {
        return new com.tencentcloud.tdsql.mysql.cj.jdbc.Clob(getExceptionInterceptor());
    }

    @Override
    public Blob createBlob() {
        return new com.tencentcloud.tdsql.mysql.cj.jdbc.Blob(getExceptionInterceptor());
    }

    @Override
    public NClob createNClob() {
        return new com.tencentcloud.tdsql.mysql.cj.jdbc.NClob(getExceptionInterceptor());
    }
