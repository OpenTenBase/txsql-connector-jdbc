...
package com.tencentcloud.tdsql.mysql.cj.jdbc.jmx;
...
public class LoadBalanceConnectionGroupManager implements LoadBalanceConnectionGroupManagerMBean {
    ...
    public synchronized void registerJmx() throws SQLException {
        ...
        try {
            ObjectName name = new ObjectName("com.tencentcloud.tdsql.mysql.cj.jdbc.jmx:type=LoadBalanceConnectionGroupManager");
