...
public class StatementWrapper extends WrapperBase implements Statement {
    ...
    public ResultSet getResultSet() throws SQLException {
        try {
            if (this.wrappedStmt != null) {
                ...
                if (rs != null) {
                    ((com.tencent.tdsql.mysql.cj.jdbc.result.ResultSetInternalMethods) rs).setWrapperStatement(this);
                }
                return rs;
            }
    ...
    public void enableStreamingResults() throws SQLException {
        try {
            if (this.wrappedStmt != null) {
                ((com.tencent.tdsql.mysql.cj.jdbc.JdbcStatement) this.wrappedStmt).enableStreamingResults();
            } else {
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        ...
        return (interfaceClassName.equals("com.tencent.tdsql.mysql.cj.jdbc.Statement") || interfaceClassName.equals("java.sql.Statement")
