...
public class ConnectionWrapper extends WrapperBase implements JdbcConnection {
    ...
    @Override
    public boolean isSameResource(com.tencent.tdsql.mysql.cj.jdbc.JdbcConnection c) {
    ...
    @Override
    public void registerStatement(com.tencent.tdsql.mysql.cj.jdbc.JdbcStatement stmt) {
    ...
    @Override
    public void unregisterStatement(com.tencent.tdsql.mysql.cj.jdbc.JdbcStatement stmt) {
