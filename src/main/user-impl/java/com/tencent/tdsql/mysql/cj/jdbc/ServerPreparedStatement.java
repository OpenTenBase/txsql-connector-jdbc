...
import com.tencent.tdsql.mysql.cj.CancelQueryTask;
...
import com.tencent.tdsql.mysql.cj.ServerPreparedQueryBindValue;
import com.tencent.tdsql.mysql.cj.ServerPreparedQueryBindings;
...
public class ServerPreparedStatement extends ClientPreparedStatement {
    ...
    public String asSql(boolean quoteStreamsAndUnknowns) throws SQLException {
        synchronized (checkClosed().getConnectionMutex()) {
            ...
            try {
                pStmtForSub = getInstance(this.connection, ((PreparedQuery<?>) this.query).getOriginalSql(), this.getCurrentDatabase());
    ...
    @Override
    protected <M extends Message> com.tencent.tdsql.mysql.cj.jdbc.result.ResultSetInternalMethods executeInternal(int maxRowsToRetrieve, M sendPacket,
