...
import com.tencent.tdsql.mysql.cj.CacheAdapter;
import com.tencent.tdsql.mysql.cj.CacheAdapterFactory;
import com.tencent.tdsql.mysql.cj.LicenseConfiguration;
import com.tencent.tdsql.mysql.cj.Messages;
import com.tencent.tdsql.mysql.cj.NativeSession;
import com.tencent.tdsql.mysql.cj.NoSubInterceptorWrapper;
import com.tencent.tdsql.mysql.cj.ParseInfo;
import com.tencent.tdsql.mysql.cj.PreparedQuery;
import com.tencent.tdsql.mysql.cj.ServerVersion;
import com.tencent.tdsql.mysql.cj.Session.SessionEventListener;
...
import com.tencent.tdsql.mysql.cj.jdbc.ha.MultiHostMySQLConnection;
...
import com.tencent.tdsql.mysql.cj.jdbc.result.CachedResultSetMetaDataImpl;
...
import com.tencent.tdsql.mysql.cj.protocol.SocksProxySocketFactory;
...
public class ConnectionImpl implements JdbcConnection, SessionEventListener, Serializable {
    ...
    private java.sql.DatabaseMetaData getMetaData(boolean checkClosed, boolean checkForInfoSchema) throws SQLException {
        ...
        com.tencent.tdsql.mysql.cj.jdbc.DatabaseMetaData dbmeta = com.tencent.tdsql.mysql.cj.jdbc.DatabaseMetaData.getInstance(getMultiHostSafeProxy(), this.database, checkForInfoSchema,
    ...
    private void initializePropsFromServer() throws SQLException {
        ...
        ((com.tencent.tdsql.mysql.cj.jdbc.DatabaseMetaData) this.dbmd).setMetadataEncoding(getSession().getServerSession().getCharacterSetMetadata());
        ((com.tencent.tdsql.mysql.cj.jdbc.DatabaseMetaData) this.dbmd).setMetadataCollationIndex(getSession().getServerSession().getMetadataCollationIndex());
    ...
    public Clob createClob() {
        return new com.tencent.tdsql.mysql.cj.jdbc.Clob(getExceptionInterceptor());
    }

    @Override
    public Blob createBlob() {
        return new com.tencent.tdsql.mysql.cj.jdbc.Blob(getExceptionInterceptor());
    }

    @Override
    public NClob createNClob() {
        return new com.tencent.tdsql.mysql.cj.jdbc.NClob(getExceptionInterceptor());
    }
                ...
                try {
                    try {
                        ...
                        try {
                            ...
                            this.infoProvider = (ClientInfoProvider) Util.getInstance("com.tencent.tdsql.mysql.cj.jdbc." + clientInfoProvider, new Class<?>[0], new Object[0],
                                    getExceptionInterceptor());
