...
import com.tencent.tdsql.mysql.cj.BindValue;
import com.tencent.tdsql.mysql.cj.CancelQueryTask;
import com.tencent.tdsql.mysql.cj.ClientPreparedQuery;
import com.tencent.tdsql.mysql.cj.ClientPreparedQueryBindings;
        ...
        synchronized (checkClosed().getConnectionMutex()) {
            ...
            try {
                ...
                try {
                    ...
                    if (numBatchedArgs > 1) {
                        long updCount = updateCountRunningTotal > 0 ? SUCCESS_NO_INFO : 0;
