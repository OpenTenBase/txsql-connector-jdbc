...
public class SchemaImpl implements Schema {
    ...
    public List<Collection> getCollections(String pattern) {
        ...
        Predicate<com.tencent.tdsql.mysql.cj.result.Row> rowFiler = r -> (strTypes).contains(r.getValue(1, this.svf));
        Function<com.tencent.tdsql.mysql.cj.result.Row, String> rowToName = r -> r.getValue(0, this.svf);
